    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="bg-white rounded-lg shadow-lg max-w-full w-full p-6 h-[1209px]">
        ...
        <div className="flex items-center mb-4">
          <button className="text-gray-500 mr-2">{/* Back Icon */}←</button>
        ...
        <div className="bg-gray-100 p-4 rounded-lg mb-6">
          ...
          <div className="flex items-center mb-3">
            <span className="material-icons text-2xl text-gray-700 mr-3">
              assignment
            </span>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-2xl text-gray-700 space-y-2">
            <li>
              10 points awarded for a correct answer and no points for an
              incorrect answer
            </li>
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside text-2xl text-gray-700 space-y-2 mt-2">
            ...
            <li>
              Any misuse of the platform, such as cheating, will result in
              disqualification.
            </li>
            <li>
              Your results may be displayed on the leaderboard if applicable.
            </li>
          </ul>
        </div>
