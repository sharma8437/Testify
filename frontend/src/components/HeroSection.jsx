        ...
        <div className="w-full md:w-1/2 mt-14 md:mt-36 order-2 md:order-1">
          <div className="space-y-10">
            <h1 className="text-5xl font-bold">
              {" "}
              Where skill meet{" "}
              <span className="text-red-500 text-5xl"> opportunity!!!</span>
            </h1>
            ...
            <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="text" className="grow" placeholder=" Type your experience...." />
            </label>
          </div>
          <button className="btn btn-active  bg-red-600 mt-6 text-white">
            FeedBack
          </button>
        </div>
